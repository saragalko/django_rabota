    ...
    if request.user.is_authenticated:
        ...
        if request.method == 'POST':
            ...
            if user is not None:
                ...
                thank = True
                return render(request, 'user_login.html', {'thant': thank})
...
def add_job(request):
    ...
    if request.method == 'POST':
        ...
        job = Job.objects.create(company=company, title=title, start_date=start_date, end_date=end_date,
                                 salary=salary, image=image, experience=experience, location=location, skills=skills,
